...
Deze hebben beiden verschillende eisen en vanaf nu zullen we dus deze twee als verschillende entiteiten beschouwen.
Het is mogelijk dat voor de updater een andere oplossing voorzien gaat moeten worden aangezien de eisen anders zijn.
