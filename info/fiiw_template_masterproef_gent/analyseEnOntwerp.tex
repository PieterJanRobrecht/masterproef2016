...
Er worden evenwel enkele kleine aanpassingen gemaakt aan de verschillende structuren die worden aangehaald.

\paragraph{Agenten}
%%schrijven over hoe de agenten werken en hoe ze gaan werken volgens de handelingen van ORYA
Naast de docks bevat de software dock architectuur ook agenten.
