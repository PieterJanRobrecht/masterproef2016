...
%%% TODO schrijven wat doel van release dock is -> kijk naar klassendiagram
...
\begin{figure}[!ht]
\centering
\makebox[0pt]{\includegraphics[scale=0.5]{afbeelding/overViewGUI.png}}
...
\begin{figure}[!ht]
\centering
\makebox[0pt]{\includegraphics[scale=0.5]{afbeelding/releaseCreator.png}}
...
\begin{figure}[!ht]
\centering
\makebox[0pt]{\includegraphics[scale=0.6]{afbeelding/seqStartServer.png}}
...
%%% TODO hier zeggen wat de release flow is?
