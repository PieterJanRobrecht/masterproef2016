...
\citep{encyclo} beschrijft de client-server architectuur als een architectuur van een computernetwerk waarin verscheidene clients services van een gecentraliseerde server opvragen en ontvangen.
...
Een voordeel aan de client-server architectuur is dat clients zich niet moeten bezig houden met het verwerken van data.
Clients kunnen zich focussen op het opvragen van informatie van de gebruikers en de server en clients kunnen zich focussen op het weergeven van deze data \citep{oracleClientServer}.
...
Bij het uitvallen van deze component, is het niet mogelijk om 
...
\citet{mesbah2008component} legt uit dat het client-geïnitieerde afhaalmodel inefficiënt is voor real-time event notificaties.
