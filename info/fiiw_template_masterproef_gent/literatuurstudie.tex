...
\section{Deployment strategieën}
...
\begin{tabular}{clll}
\hline
\multicolumn{4}{c}{\textbf{WiX Toolset}}                    \\ \hline
\multicolumn{2}{c}{Pro} & \multicolumn{2}{c}{Cons} \\ \hline
\multicolumn{2}{l}{Diepe integratie met Windows \par Mogelijkheid om externe executables te includeren}   & \multicolumn{2}{l}{XML structuren zorgt voor veel schrijfwerk \par Niet cross-platform}    \\ \hline
\multicolumn{4}{c}{\textbf{NSIS}}                           \\ \hline
\multicolumn{2}{c}{Pro} & \multicolumn{2}{c}{Cons} \\ \hline
\multicolumn{2}{l}{Scripting taal \par Verschillende plug-ins beschikbaar}   & \multicolumn{2}{l}{ Niet cross-platform \par Geen structuur voor packages}    \\ \hline
\multicolumn{4}{c}{\textbf{Chocolatey}}                     \\ \hline
\multicolumn{2}{c}{Pro} & \multicolumn{2}{c}{Cons} \\ \hline
\multicolumn{2}{l}{Volledige deployment infrastructuur al aanwezig}   & \multicolumn{2}{l}{Niet cross-platform \par Command-line tool}    \\ \hline
\multicolumn{4}{c}{\textbf{Qt Installer Framework}}         \\ \hline
\multicolumn{2}{c}{Pro} & \multicolumn{2}{c}{Cons} \\ \hline
\multicolumn{2}{l}{Cross-platform \par Mogelijkheid om externe executables te includeren}   & \multicolumn{2}{l}{XML structuren zorgt voor veel schrijfwerk \par Enkel Linux installer maken in Linux} \\ \hline
\end{tabular}
\end{table}
