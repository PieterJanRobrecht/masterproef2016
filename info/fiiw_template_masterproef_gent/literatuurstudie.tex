...
\multirow{-2}{*}{WiX Toolset}                                                           & Mogelijkheid om externe executables te includeren                        & Niet cross-platform                                               \\ \hline
\rowcolor[HTML]{C0C0C0} 
\cellcolor[HTML]{C0C0C0}                                                                & Scripting taal                                                           & Geen structuur voor packages                                      \\
\rowcolor[HTML]{C0C0C0} 
\multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}NSIS}                                          & Verschillende plug-ins beschikbaar                                       & Niet cross-platform                                               \\ \hline
                                                                                        & Volledige deployment infrastructuur al aanwezig                          & Command-line tool                                                 \\
\multirow{-2}{*}{Chocolatey}                                                            &                                                                          & Niet cross-platform                                               \\ \hline
\rowcolor[HTML]{C0C0C0} 
\cellcolor[HTML]{C0C0C0}{\color[HTML]{000000} }                                         & {\color[HTML]{000000} Cross-platform}                                    & {\color[HTML]{000000} XML structuren zorgt voor veel schrijfwerk} \\
\rowcolor[HTML]{C0C0C0} 
\multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}{\color[HTML]{000000} Qt Installer Framework}} & {\color[HTML]{000000} Mogelijkheid om externe executables te includeren} & {\color[HTML]{000000} Enkel Linux installer maken in Linux}       \\ \hline
\end{tabular}%
}
\caption{Voor- en nadelen van de verschillende technologieën}
\label{tab:voorNadelen}
